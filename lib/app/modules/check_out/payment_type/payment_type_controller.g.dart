...
mixin _$PaymentTypeController on _PaymentTypeControllerBase, Store {
  final _$valueAtom = Atom(name: '_PaymentTypeControllerBase.value');
  ...
  final _$_PaymentTypeControllerBaseActionController =
      ActionController(name: '_PaymentTypeControllerBase');

  @override
  void increment() {
    final _$actionInfo = _$_PaymentTypeControllerBaseActionController
        .startAction(name: '_PaymentTypeControllerBase.increment');
    try {
