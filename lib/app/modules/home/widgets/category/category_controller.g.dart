...
mixin _$CategoryController on _CategoryControllerBase, Store {
  final _$categoryListAtom = Atom(name: '_CategoryControllerBase.categoryList');

  @override
  ObservableFuture<List<CategoryModel>> get categoryList {
    _$categoryListAtom.reportRead();
    return super.categoryList;
  }

  @override
  set categoryList(ObservableFuture<List<CategoryModel>> value) {
